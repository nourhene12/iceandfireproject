...
if(isset($_POST['modifier'])){
    ...
    $nouveau_cont->setprenom($_POST['prenom']);

    
    $nouveau_cont->setEmail($_POST['email']);
   
    $nouveau_cont->updateContacts($nouveau_cont,$id);
    }
}
?>
<!DOCTYPE HTML>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea name="message" class="form-control" id="" cols="30" rows="7" placeholder="Message" <?php echo htmlspecialchars($row['message'], ENT_QUOTES, 'UTF-8'); ?>></textarea>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											  <label for="nom">Nom</label>
											<input name="nom" type="text" class="form-control" placeholder="Nom" value="<?php echo $row['nom']; ?>"  onkeyup="validatetext(this)">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
