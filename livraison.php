                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="adresse" name="adresse"onkeyup="validatephone(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="ville" name="ville"onkeyup="validatephone(this)">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="code" name="code"onkeyup="validatephone(this)">
										...
										<div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="cmp" name="cmp"onkeyup="validatephone(this)">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="civ" name="civ"onkeyup="validatephone(this)">
