...
if (isset($_POST["valider"])) 
{
    ...
    $nouveau_livraison->setCivilite($_POST['civilite']);
    $nouveau_livraison->setVille($_POST['ville']);
    $nouveau_livraison->setNom($_POST['nom']);
    $nouveau_livraison->setPrenom($_POST['prenom']);
    $nouveau_livraison->setAdresse($_POST['adresse']);
    $nouveau_livraison->setComplementDadresse($_POST['complement_d_adresse']);
    $nouveau_livraison->setCodePostal($_POST['code_postal']);
    $nouveau_livraison->InsererLivraison($nouveau_livraison);
}
ob_end_flush();
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
                                <div class="slider-text-inner text-center">
                                    <div class="desc">
                                        ...
                                        <h1>Faire votre livraison</h1>
                                        <p><span><a href="#">Acceuil</a></span> <span>Livraison</span></p>
                                        <div class="desc2"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
								        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                 ...
                                                 <option name="tab" value="Madame">Madame</option>
                                                 <option name="tab" value="Monsieur">Monsieur</option>
                                                 <option name="tab" value="Autre">Autre</option>
                                                 </select>
										...
										<div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                 ...
                                                 <option name="tab" value="Tunis">Tunis</option>
                                                 <option name="tab" value="Sfax">Sfax</option>
                                                 <option name="tab" value="Hammamet">Hammamet</option>
                                                 <option name="tab" value="Sousse">Sousse</option>
                                                 <option name="tab" value="Bizerte">Bizerte</option>
                                                 </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                <input type="text" class="form-control" placeholder="Votre Nom" name="nom" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                <input type="text" class="form-control" placeholder="Votre Prénom" name="prenom" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                <input type="text" class="form-control" placeholder="Votre Adresse" name="adresse" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                <input type="text" class="form-control" placeholder="Complement d'adresse" name="complement_d_adresse">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                <input type="text" class="form-control" placeholder="Votre Code Postal" name="code_postal" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 animate-box">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-4">
                                                    <input type="submit" name="valider" id="submit" value="Faire la livraison" class="btn btn-primary btn-block" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                        ...
                        <?php
                         ...
                         if(isset($_POST['supprimer'])){
                            $d->SupprimerLivraison($_POST['ref']);
                         }
                        ?>
                          </p>
                </div>
