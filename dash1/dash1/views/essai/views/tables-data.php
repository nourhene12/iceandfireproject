...
<form method="POST" action="afficherReservationtrie.php"> 
 <input type="submit" name="trie" value="trie" >
 </form>
         
         <form  method="POST" style="        margin-left: 143px;margin-bottom: 2px;" >
                     <input type="text" placeholder=" Date" name="choix" />
