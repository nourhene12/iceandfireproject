                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">23569DT</span></div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Evenements</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="tdl-holder">
                                            <div class="tdl-content">
                                                <ul>
                                                    <li>
                                                        <label>
                                                            <input type="checkbox"><i class="check-box"></i><span>Appeler les fournisseurs du Nutella ....</span>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox"><i class="check-box"></i><span>Acheter des fraises et des kiwis</span>
                                                            <a href='#' class="fa fa-times"></a>
                                                            <a href='#' class="fa fa-pencil"></a>
                                                            <a href='#' class="fa fa-check"></a>
                                                        </label>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" checked><i class="check-box"></i><span>Verififer la réservation de l'anniversaire </span>
                                                            <a href='#' class="fa fa-times"></a>
                                                            <a href='#' class="fa fa-pencil"></a>
                                                            <a href='#' class="fa fa-check"></a>
                                                        </label>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" checked><i class="check-box"></i><span>Préparer les commandes</span>
                                                            <a href='#' class="fa fa-times"></a>
                                                            <a href='#' class="fa fa-pencil"></a>
                                                            <a href='#' class="fa fa-check"></a>
                                                        </label>
                                                    ...
                                                    <li>
                                                        <label>
                                                            <input type="checkbox" checked><i class="check-box"></i><span>Rendez-vous pour l'interview</span>
                                                            <a href='#' class="fa fa-times"></a>
                                                            <a href='#' class="fa fa-pencil"></a>
                                                            <a href='#' class="fa fa-check"></a>
                                                        </label>
...
<?php
 $con = mysqli_connect('localhost','root','','iceandfiredb');
?>
<!DOCTYPE HTML>
<html>
<head>
 ...
 ['action', 'nombre'],
 <?php 
$query =" select (SELECT COUNT(*) FROM reclamation) as count, 
       (SELECT COUNT(*) FROM temoignage) as count2 ";

 $exec = mysqli_query($con,$query);
 while($row = mysqli_fetch_array($exec)){

 echo "['Réclamations',".$row['count']."],";
 echo "['Témoignage',".$row['count2']."],";
 }
 ?>
 ]);
 ...
 var options = {
 title: 'Statistiques : Réclamation & Témoignage'
 };
...
<body>
 <h3>Statistiques : Réclamation & Témoignage</h3>
