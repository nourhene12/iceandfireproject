...
if (isset($_POST["valider"])) {
    ...
    $nouveau_reclamation->TrieReclamation($nouveau_reclamation);
}
ob_end_flush();
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
            <div class="breadcrumbs-inner">
               ...
               <div class="col-lg-6" style="margin-left: 21px;">
       ...
       <div>
         <?php
  function TrieReclamation(){

}
?>
<input type"submit" name="trie" value="trie" onclick="TrieReclamation();"  >
