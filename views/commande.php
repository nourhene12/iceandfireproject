...
<html>
  ...
  <!-- Facebook and Twitter integration -->
    ...
    <script src="controlesaisie1.js"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
                                <div class="slider-text-inner text-center">
                                    <div class="desc">
                                        ...
                                        <p><span><a href="#">Accueil</a></span> <span>COMMANDE</span></p>
                                        <div class="desc2"></div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" class="class="colorlib-form" name="myForm" action="commande.php">
                                <div class="row">
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                <label for="id_client">id_client</label>
                                                <div class="form-field">
                                                <input type="number" class="form-control" placeholder="id_client1" name="id_client" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="number" class="form-control" placeholder="facture1" name ="facture" onchange="validatetext(this)">
                                        ...
                                        <div class="col-md-12 animate-box">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-4">
                                                    <input type="submit" name="valider" id="submit" onclick=" return verif()" value="confirmer" class="btn btn-primary btn-block" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
