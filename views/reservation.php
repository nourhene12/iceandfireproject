 ...
 * Time: 10:18
 */
include_once "../entities/reserv1.php";
...
if (isset($_POST["valider"])) {
    ...
    $nouveau_reserv->insertReservation($nouveau_reserv);
}
ob_flush();
?>
<!DOCTYPE HTML>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
                                <div class="slider-text-inner text-center">
                                    <div class="desc">
                                        ...
                                        <h1>Faire votre reservation </h1>
                                        <p><span><a href="#">Acceuil</a></span> <span>Réservation</span></p>
                                        <div class="desc2"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="nom" name="nom" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                          <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                <input type="text" class="form-control" placeholder="prenom" name="prenom" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    ...
                                                    <TEXTAREA class="form-control" placeholder="description" rows=4 cols=40 name="description"></TEXTAREA>
                                        ...
                                        <div class="col-md-12 animate-box">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-4">
                                                    <input type="submit" name="valider" id="submit" value="Reserver" class="btn btn-primary btn-block" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
       ...
       <div class="colorlib-intro">
        ...
        <div class="colorlib-reservation reservation-page">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center animate-box intro-heading">
                        <h2>Afficher les reservations </h2>
                        </div>
                          <p style="display: none;" id="affiche">
        <?php
        $d = new Reservation();
        $d->afficheReservation();
        if(isset($_POST['supprimer'])){
        $d->supprimeReservation($_POST['ref']);
        }
        ?>
    </p>
                </div>
