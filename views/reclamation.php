                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="email" name ="email" onchange="email_validate(this.value)" required>
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="phone" name="phone"onkeyup="validatephone(this)" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    ...
                                                    <TEXTAREA class="form-control" placeholder="reclamation" rows=4 cols=40 name="reclamation_message" onkeyup="validatetext(this)" required>Entrer bla bla bla </TEXTAREA>
                                        ...
                                        <div class="col-md-12 animate-box">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-4">
                                                    <input type="submit" name="valider" id="submit" value="Faire la réclamation" class="btn btn-primary btn-block" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
