...
if (isset($_POST["valider"])) {
	...
	$nouveau_livraison->insertLivraison($nouveau_livraison);
}
?>
<!DOCTYPE html>
<html>
            ...
            <div class="colorlib-table-cell js-fullheight">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <ul><li class="active"><a href="index.php">Acceuil</a></li>
            ...
            <div class="container">
               ...
               <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="row">
                            <div class="col-md-12">
                                <form name="livrai" method="post" class="colorlib-form">
                                <div class="row">
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                <label for="name">Nom:</label>
                                                <div class="form-field">
                                                <input type="text" class="form-control" placeholder="Veuillez saisir votre nom" name="name" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="Veuillez saisir votre prénom" name ="prenom" >
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="Rue ,Numéro , Etage" name="adresse">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="Tunisie,Sfax,Sousse,Nabeul" name="ville">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="Veuillez saisir votre code postal" name="code"">
										...
										<div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                <label for="cmp">Complément D'adresse:</label>
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="Code Porte , Numéro Société " name="cmp"">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="Madame , Monsieur" name="civ" required>
