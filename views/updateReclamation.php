                                ...
                                <div class="row">
                                        <div class="col-md-6 animate-box">
                                         ...
                                         <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="email" name="email" value="<?php echo $row['email']; ?>" onchange="email_validate(this.value)">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="phone"  name="phone"value="<?php echo $row['phone']; ?>" onkeyup="validatephone(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                         ...
                                         <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                             <textarea type="" name="message" class="form-control" rows="3" cols="21"><?php echo htmlspecialchars($row['message'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
