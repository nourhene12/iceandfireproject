...
$listecat=$controlcate->affichercatégories();
?>
<!doctype html>
...
<div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <option value="">entrez la categorie</option>
                                                                <?php
                                                               $controlcate = new categoriec(); 
$listecat=$controlcate->affichercatégories();
...
$listeproduits=$produitc1->afficherproduits();
    ...
    ?>
                 ...
                 <button name="Excel" id="Excel">Excel</button>
                 <button id="Csv">CSV</button> 
                 <button id="word">Microsoft Word</button>         
