	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/img.jpeg);" data-stellar-background-ratio="0.5">
				   			...
				   			<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<div class="desc">
					   					...
					   					<h1>Notre menu</h1>
					   					<p><span><a href="#">Acceuil</a></span> <span>Menu</span></p>
					   					<div class="desc2"></div>
				   					</div>
				   				</div>
				   			</div>
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3 text-center animate-box intro-heading">
							...
							<h2>Ice and Fire Menu</h2>
							   <h3 class="text-center text-dark mt-2">NOS nouveaux produits </h3>
							 </div>
							 <div class="col-md-12 animate-box text-center">
							<p><a href="filter.php" class="btn btn-primary btn-outline btn-md">chercher votre prix</a></p>
						</div>
							<body>
