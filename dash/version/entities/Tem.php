...
$this->db =$this ->db->connect();	}
    ...
    public function afficheTemoignage()
    {
        ...
        try {
            ...
            echo "<tr><th scope='col'>Id</th><th scope='col'>Name</th><th scope='col'>Date</th><th scope='col'>Message</th><th scope='col'>DELETE</th><th scope='col'>UPDATE</th></tr>";
            foreach ($res as $row) {
                 echo "<tr><td>" . $row['id'] . "</td><td>" . $row['name'] . "</td><td>" . $row['date'] . "</td><td>" . $row['message'] . "</td>"."<td><form method='post' action='#'><input type='text' value=".$row['id']." name='ref' hidden> <input type='submit' class='btn btn-primary btn-block' style='width:47%!important' value='supprmier' name='supprimer'></form></td>"."<td><a href='updateTemoignage.php?p=" . $row['id'] . "'>Modifier</a></td>" . "</tr>";
            }
            echo "</table>";
