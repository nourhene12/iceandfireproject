            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center animate-box intro-heading">
                        ...
                        <p>pour modifier vos coordonnées, veuillez remplir ce formulaire.</p>
                                        ...
                                        <div class="col-md-12 animate-box">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-4">
                                                    <input type="submit" Nom="valider" id="submit" value="Enregistrer" class="btn btn-primary btn-block" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    function validatTel(Tel)
        {
            ...
            Tel.value = maintainplus + curphonevar;
            var maintainplus = '';
