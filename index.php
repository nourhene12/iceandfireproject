...
if (isset($_POST["valider"])) {
    ...
    $nouveau_reclamation->insertRecalamtion($nouveau_reclamation);
}
?>
...
<head>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <ul>
                            ...
                            <li><a href="temoignage.html">Qu'en-pensez-vous ?</a></li>
    ...
    <div id="colorlib-page">
                                ...
                                <div class="row">
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="name" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="email" onchange="email_validate(this.value)">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    <input type="text" class="form-control" placeholder="phone" onkeyup="validatephone(this)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 animate-box">
                                        ...
                                        <div class="col-md-6 animate-box">
                                            <div class="form-group">
                                                ...
                                                <div class="form-field">
                                                    ...
                                                    <TEXTAREA class="form-control" placeholder="reclamation" rows=4 cols=40>Entrer bla bla bla </TEXTAREA>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 animate-box">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-4">
                                                    <input type="submit" name="submit" id="submit" value="Faire la réclamation" class="btn btn-primary btn-block" onkeyup="validatetext(this)">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
        ...
        <div class="colorlib-reservation reservation-page">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center animate-box intro-heading">
                        <h2>Afficher une réclamation</h2>
                        <p>Si vous-avez des problémes n'hésitez pas a les signaler en remplissant le formulaire suivant</p>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-12 animate-box">
                                            <div class="row">
                                                <div class="col-md-4 col-md-offset-4">
                                                    <input type="submit" name="submit" id="submit" value="afficher" class="btn btn-primary btn-block" onclick="affiche()">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    <!---création d'un bloc avec JS pour afficher la liste des reclamations si l'utilisateur clique "afficher"---->
