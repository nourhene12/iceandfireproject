...
if($_GET['submit'])
{
update($_GET['idt'],$_GET['topics'],$_GET['details']);
header('Location: '.$_SERVER['PHP_SELF']);
}
?>
<!doctype html>
...
<body>
    <!-- Left Panel --> <aside id="left-panel" class="left-panel">
                    ...
                    <li class="menu-item-has-children active dropdown">
                      ...
                      <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-search"></i><a href="table basic.php">Table de recherche</a></li>
                             <li><i class="menu-icon fa fa-search"></i><a href="blogpostdisplay.php">Table de blogs</a></li>
                            <li><i class="menu-icon fa fa-search"></i><a href="topicdisplay.php">Table de posts forum</a></li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <a role="button" href="<?php echo"index.php";?>" class="btn btn-info">Back</a>
<div class="content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php foreach ($topic as $key ) {
                                        ?>
                                        <tr>
                                            <td><?php echo $key['id'] ;?></td>
                                            <form methode='GET' name ="edit" id="edit">
                                            <input type="text" name="idt" hidden="true" value="<?php echo $key['id'] ;?>"> 
                                            <td id="topic" ><?php echo $key['topic'] ;?><input type="text" name="topics" placeholder="Edit topic"></td>
                                            <td id="detail"><?php echo $key['detail']; ?><input type="text" name="details" placeholder="Edit details"></td>
                                            </form>
                                            <td><?php echo $key['name'] ;?></td>
                                            <td><?php echo $key['email']; ?></td>
                                            <td><?php echo $key['datetime'] ;?></td>
                                            <td><?php echo $key['reply'] ;?></td>
                                            <td> <button type="submit" name="submit" value="submit" form="edit" class="btn btn-info">Update</a></td>
                                            <td> <a role="button" href="<?php echo"topicdisplay.php?id=".$key['id'];?>" class="btn btn-danger">Delete</a></td>
